...
13. retentionPolicy 수신 및 Result Policy Router 필요 여부
14. notify_only 이메일 MD 첨부 처리 방식
   - MD 임시 생성 여부
   - 이메일 본문 또는 첨부 전송 여부
   - DB/Storage/resultRefs 미보관 여부
15. processorResult 생성 상태
16. callback 구조 상태
17. Sticky Note 갱신 필요 여부
18. 노드 시각화 배치/번호 체계 정리 필요 여부
19. Google Drive / Optional Export 구조
   - optionalExportProvider
