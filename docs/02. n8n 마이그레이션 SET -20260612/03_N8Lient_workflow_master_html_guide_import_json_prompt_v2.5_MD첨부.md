# N8Lient 워크플로우 마스터 등록 HTML 가이드 & Import JSON 생성 프롬프트 v2.5 단독형
...
v2.5는 v2.4의 실행 Validation 계약을 유지하면서, Level 1 `notify_only`의 이메일 MD 첨부 정책을 명확히 하기 위한 버전이다.
...
```text
N8Lient_워크플로우_마스터_등록가이드_{workflowKey}_v2.5.html
```
