# N8Lient 워크플로우 마스터 등록 HTML 가이드 & Import JSON 생성 프롬프트 v2.4 단독형
...
v2.4는 실행 Validation을 더 정확히 하기 위한 버전이다.
...
```text
N8Lient_워크플로우_마스터_등록가이드_{workflowKey}_v2.4.html
```
