# Workflow for N8Lient 마이그레이션 세트 1.0
...
```text
00_README_Workflow_for_N8Lient_마이그레이션_세트_v1.0.md
01_START_작업모드_선택_프롬프트_v1.0.md
02A_MODE1_커스터마이징_디자인동시_프롬프트_v1.0.md
02B_MODE2_커스터마이징_only_프롬프트_v1.0.md
02C_MODE3_이메일디자인_only_프롬프트_v1.0.md
03_MODE4_워크플로우_등록가이드_ImportJSON_생성_프롬프트_v1.0.md
references_email_design_v3_3_optional/
```

## 사용 방식

먼저 `01_START_작업모드_선택_프롬프트_v1.0.md`를 새 대화창 첫 메시지로 넣는다.
